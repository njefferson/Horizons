...
Why Wynts is shaped the way it is.
...
**Two things this document is not.** It is not a claim that Wynts is a
...
> **Nothing in Wynts may assume willpower is a tank** — no "you have used your
> focus for today", no depletion model, no discipline framing.
> **Nothing in Wynts may claim to train an underlying capacity.** It is a
...
protect the current block, return. Wynts borrows the **shape** — capture
...
| **Working-memory training does not transfer** to untrained tasks or daily function | **negative finding** | Wynts never claims to improve an underlying capacity. No exercises, no scores, no "getting better". It is a prosthesis. Saying otherwise would be selling something that does not work — Doctrine §5. |
...
## 11 · The five things Wynts claims are different
...
> Wynts claims no affiliation with, endorsement by, or compatibility with any
