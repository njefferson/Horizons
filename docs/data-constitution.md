...
What Perennial stores, what it promises about it, and every way out.
...
- **No location, no contacts, no calendar reading.** The `.ics` export is
  one-way — Perennial writes a file, and never reads your calendar.
...
reminding. A point-in-time snapshot: change a date in Perennial and the exported
...
**Perennial is a personal app.** It is not designed for, tested on, or approved for
...
any other personal device. Perennial does not inspect, classify, or police what you
